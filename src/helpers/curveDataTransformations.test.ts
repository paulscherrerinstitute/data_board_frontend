...
describe("filterCurveData", () => {
    const sampleData = {
        curve: {
            ...
            max: { "1000": 2, "2000": 3 },
            meta: {
                pointMeta: { "1000": { a: 1 }, "2000": { a: 2 } },
            },
        },
    } as unknown as StoredCurveData;

    it("filters data within range", () => {
        const result = filterCurveData(sampleData, "1500", "2500");
    ...
    it("returns empty if nothing in range", () => {
        const result = filterCurveData(sampleData, "3000", "4000");
